...
export declare function createFileTransform(config: TemplateConfig): (entry: tar.ReadEntry) => Transformer | undefined;
/**
...
export declare function createEntryResolver(name: string): (entry: tar.ReadEntry) => void;
export {};
