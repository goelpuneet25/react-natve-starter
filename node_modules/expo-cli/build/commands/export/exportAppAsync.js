...
async function exportAppAsync(projectRoot, publicUrl, assetUrl, outputDir, options = {}, experimentalBundle) {
  ...
  await _xdl().Project.writeArtifactSafelyAsync(projectRoot, null, iosJsPath, iosBundle);
  await _xdl().Project.writeArtifactSafelyAsync(projectRoot, null, androidJsPath, androidBundle);
