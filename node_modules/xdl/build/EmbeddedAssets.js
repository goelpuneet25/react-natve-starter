...
async function _maybeWriteArtifactsToDiskAsync(config) {
    var _a, _b, _c, _d;
    const { projectRoot, pkg, exp, iosManifest, iosBundle, androidManifest, androidBundle, target, } = config;
    ...
    if ((_c = exp.ios) === null || _c === void 0 ? void 0 : _c.publishBundlePath) {
        iosBundlePath = exp.ios.publishBundlePath;
    }
    if ((_d = exp.ios) === null || _d === void 0 ? void 0 : _d.publishManifestPath) {
