...
export declare function openAppAsync(device: Pick<Device, 'pid' | 'type'>, { packageName, mainActivity, }: {
    packageName: string;
    mainActivity: string;
}): Promise<string>;
...
export declare function parseAdbDeviceProperties(devicePropertiesString: string): Record<string, string>;
