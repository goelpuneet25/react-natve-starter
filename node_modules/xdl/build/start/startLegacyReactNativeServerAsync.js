...
async function startReactNativeServerAsync({ projectRoot, options = {}, exp = config_1.getConfig(projectRoot).exp, verbose = true, }) {
    ...
    let packagerPort = (_a = options.metroPort) !== null && _a !== void 0 ? _a : (await internal_1.getFreePortAsync(19001)); // Create packager options
    ...
    if (userPackagerOpts) {
        ...
        const userSourceExts = (_b = userPackagerOpts.sourceExts) !== null && _b !== void 0 ? _b : [];
