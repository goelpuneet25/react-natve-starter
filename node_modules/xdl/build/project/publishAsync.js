...
async function publishAsync(projectRoot, options = {}) {
    ...
    let androidManifest = {};
    let iosManifest = {};
    if (validPostPublishHooks.length || ((_b = exp.ios) === null || _b === void 0 ? void 0 : _b.publishManifestPath) || ((_c = exp.android) === null || _c === void 0 ? void 0 : _c.publishManifestPath) ||
    ...
    await internal_1.EmbeddedAssets.configureAsync({
        ...
        pkg,
        exp,
        releaseChannel: (_d = options.releaseChannel) !== null && _d !== void 0 ? _d : 'default',
    ...
    const url = options.releaseChannel && options.releaseChannel !== 'default'
    ...
    const projectPageUrl = response.projectPageUrl
        ...
        : null;
    return Object.assign(Object.assign({}, response), { url,
        projectPageUrl });
}
